...
bench::mark(check = FALSE,
    buffer = {
        ...
        resto_near_road = rsts_buff[road_utah.shp,]
    },
    buffer2 = {
    ...
    within_distance ={
        near_or_not = lengths(
          sf::st_is_within_distance(rsts_u, road_utah.shp, dist_to_check)) > 0
        resto_near_roadv2 = rsts[near_or_not,]
    },
    times = 100
 )
```
